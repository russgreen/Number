...
partial class Build
{
    ...
    .Executes(() =>
    {
        var aipProjectPath = Path.Combine(RootDirectory, @"Installer\Number.aip");
        var version = Solution.Number.GetProperty("Version");
    ...
    {
        var aipOutputPath = Path.Combine(RootDirectory, @"Installer\Number-SetupFiles");
